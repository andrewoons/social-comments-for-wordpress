...
include_once('SocialCommentsForWordpress_OptionsManager.php');

class SocialCommentsForWordpress_InstallIndicator extends SocialCommentsForWordpress_OptionsManager {
