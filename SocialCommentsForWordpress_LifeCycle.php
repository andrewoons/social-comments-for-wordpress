...
include_once('SocialCommentsForWordpress_InstallIndicator.php');

class SocialCommentsForWordpress_LifeCycle extends SocialCommentsForWordpress_InstallIndicator {
