...
class SocialCommentsForWordpress_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'social-comments-for-wordpress'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'social-comments-for-wordpress'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'social-comments-for-wordpress'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'social-comments-for-wordpress'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'social-comments-for-wordpress');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'social-comments-for-wordpress'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'social-comments-for-wordpress');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'social-comments-for-wordpress'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'social-comments-for-wordpress') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'social-comments-for-wordpress');
            case 'false':
                return __('false', 'social-comments-for-wordpress');

            case 'Administrator':
                return __('Administrator', 'social-comments-for-wordpress');
            case 'Editor':
                return __('Editor', 'social-comments-for-wordpress');
            case 'Author':
                return __('Author', 'social-comments-for-wordpress');
            case 'Contributor':
                return __('Contributor', 'social-comments-for-wordpress');
            case 'Subscriber':
                return __('Subscriber', 'social-comments-for-wordpress');
            case 'Anyone':
                return __('Anyone', 'social-comments-for-wordpress');
        }
        return $optionValue;
    }
